...
- `maps.html` → Finviz-style index maps for top 5 indexes:
  - S&P 500
  - Dow Jones
  - Russell 2000
  - Nasdaq 100
  - S&P 400 MidCap
- `news.html` → Clickable business news (Reuters, CNBC, Bloomberg, WSJ)
- `crypto.html` → Crypto board
- `prediction-markets.html` → Clickable Polymarket trend cards + embedded Polymarket board

## Features

- US large-cap stock strategy board (top-500 baseline).
- Category dropdown sections with expandable content.
- Each category includes:
  - Inside-category stocks (green criteria badge)
  - Borderline stocks just outside criteria (failed metric shown in red)
- Categories:
  - Low risk
  - Mid risk
  - High risk
